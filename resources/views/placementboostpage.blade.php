...
@section('content')
        ...
        <section class="boostSection">
            <div class="container">
                <h1 class="mb-4 text-center fw-bold" style="font-size: 50px;">VALORANT YERLEŞTİRME MAÇLARI</h1>
                ...
                <div class="mb-4 text-center">
                    ...
                    <a href="{{ route('placementboostpage')}}" class="btn btn-warning btn-lg mb-3 me-3">Yerleştirme Maçları</a>
                </div>
                    ...
                    <div class="row d-flex justify-content-between align-items-center border">
                        <div class="col-7 p-2 rounded" style="margin-right: 50px;">
                            <div class="form-group">
                                ...
                                <label for="currentLeague">Geçen Sezonki Liginiz:</label>
        ...
        <!--BOOST SECTİON END-->
        <script src="{{asset('assets/js/placementboost.js')}}/"></script>
@endsection
