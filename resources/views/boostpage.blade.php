...
<!--BOOST SECTİON START-->
            <section class="boostSection">
                <div class="container">
                    <h1 class="mb-4 text-center fw-bold" style="font-size: 50px;">VALORANT ELO BOOST </h1>

                    <!-- Buttons -->
                    <div class="mb-4 text-center">
                        <a href="{{ route('boost')}}" class="btn btn-warning btn-lg mb-3 me-3">Elo Boost</a>
                    ...
                    <!-- Eloboost Details -->
                    <form action="{{ route('post-boost') }}" method="POST" id="eloboostPost">
                        @csrf
                        <!-- Eloboost Details -->
                        <div class="row">
                            <div class="col-md border p-2 rounded" style="margin-right: 40px;">
                                ...
                                <select class="form-select mb-3" id="currentLeague" name="currentLeague">
                                ...
                                <select class="form-select mb-3" id="leagueDivision" name="leagueDivision">
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                </select>
                                <label for="leaguePoints">Kademe Puanı</label>
                                <select class="form-select" id="leaguePoints" name="leaguePoints">
                            ...
                            <div class="col-md border p-2 rounded">
                                ...
                                <select class="form-select mb-3" id="targetLeague" name="targetLeague">
                                    <option value="iron">Demir</option>
                                    <option value="bronze">Bronz</option>
                                    <option value="silver">Gümüş</option>
                                    <option value="gold">Altın</option>
                                ...
                                <select class="form-select mb-3" id="targetLeagueDivision" name="targetLeagueDivision">
                                    <option value="1">1</option>
                            ...
                            <div class="row">
                                <div class="col-md mt-5 me-5">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="extraWin" name="extraWin">
                                        <label class="form-check-label" for="extraWin">Boost sonu 1 win daha alınsın +15TL</label>
                                    </div>
                                    <div class="form-check form-switch mt-2">
                                        <input class="form-check-input" type="checkbox" role="switch" id="liveStream" name="liveStream">
                                        <label class="form-check-label" for="liveStream">Canlı yayın yapılsın +50TL</label>
                                    </div>
                                    <div class="form-check form-switch mt-2">
                                        <input class="form-check-input" type="checkbox" role="switch" id="offlineMode" name="offlineMode">
                                        <label class="form-check-label" for="offlineMode">Çevrimdışı Mod +15TL</label>
                                    </div>
                                </div>
            ...
            <!--BOOST SECTİON END-->
            <script src="{{asset('assets/js/eloboost.js')}}/"></script>
